                            ...
                            <div class="menu-left">
                                <div class="brand-logo">
                                    <a href="{{ route('app.index')}}">
                                        <img src="assets/images/logo.png" class="h-logo img-flgiuid blur-up lazyload"
                                            alt="logo">
                                    </a>
                                </div>
                                            ...
                                            <ul>
                                                @if(Route::has('login'))
                                                    @auth
                                                        ...
                                                        @endif
                                                        <li>
                                                            <a href="{{ route('login') }}" onclick="event.preventDefault(); document.getElementById('frmlogout').submit();" class="d-block">Logout</a>
